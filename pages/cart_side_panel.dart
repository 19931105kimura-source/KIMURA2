...
if (sent &&
        effectSetting.isEnabled &&
        totalAtSubmit >= effectSetting.threshold) {
      await _showHighValueOrderAnimation(
        context,
         effectSetting.animationPath,
        effectSetting.displayMs,
      );
    }
 ...
 Future<void> _showHighValueOrderAnimation(
    ...
    await showGeneralDialog<void>(
      ...
      pageBuilder: (_, __, ___) => _HighValueOrderAnimationDialog(
        animationUrl: customAnimationUrl,
        displayMs: displayMs,
      ),
...
class _HighValueOrderAnimationDialog extends StatefulWidget {
  const _HighValueOrderAnimationDialog({
  ...
  Future<void> _initVideo() async {
    ...
    try {
     ...
     await controller.play();
      ...
      Future<void>.delayed(Duration(milliseconds: widget.displayMs), () {
